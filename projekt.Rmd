...
V projektni nalogi bom preučeval deleže ki sestavljajo BDP za Slovenijo in Evropske države
...
```{r zemljevid.bdp.evropa, echo=FALSE, message=FALSE, fig.align='center', warning = FALSE}
print(zemljevid.bdp.evropa)
```

&nbsp;
Grafični prikaz BDP-ja na prebivalca(leto 2018) po državah nam pokaže dobro sliko z zemljevidom. Opazi se močna razlika med državami severne in južne Evrope, ter po drugi strani tudi razlika med "zahodnjaki" in "vzhodnjaki".
&nbsp;
